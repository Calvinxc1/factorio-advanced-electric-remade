...
table.insert(steam_power.effects, {type="unlock-recipe", recipe="advanced-electric-primary-steam-engine-1"})
...
steam_engine_mk2.effects ={
  {type = "unlock-recipe", recipe = "advanced-electric-steam-engine-2"},
  {type = "unlock-recipe", recipe = "advanced-electric-primary-steam-engine-2"},
}
...
steam_engine_mk3.effects = {
  {type = "unlock-recipe", recipe = "advanced-electric-steam-engine-3"},
  {type = "unlock-recipe", recipe = "advanced-electric-primary-steam-engine-3"},
}
...
steam_engine_mk4.effects = {
  {type = "unlock-recipe", recipe = "advanced-electric-steam-engine-4"},
  {type = "unlock-recipe", recipe = "advanced-electric-primary-steam-engine-4"},
}
