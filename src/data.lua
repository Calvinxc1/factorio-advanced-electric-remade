...
secondary_steam_engine_icons = {
    { icon = "__base__/graphics/icons/steam-engine.png" },
    { icon = "__base__/graphics/icons/steam-engine.png", tint = secondary_tint },
}
primary_steam_engine_icons = {
    { icon = "__base__/graphics/icons/steam-engine.png" },
    { icon = "__base__/graphics/icons/steam-engine.png", tint = primary_tint },
}

secondary_steam_turbine_icons = {
    { icon = "__base__/graphics/icons/steam-turbine.png" },
    { icon = "__base__/graphics/icons/steam-turbine.png", tint = secondary_tint },
}
primary_steam_turbine_icons = {
    { icon = "__base__/graphics/icons/steam-turbine.png" },
    { icon = "__base__/graphics/icons/steam-turbine.png", tint = primary_tint }
}
